...
export default function CivilServiceExams() {
  return (
    <div className="container my-5">
      ...
      <p>
        Preparing for civil service exams can be challenging, but with
        Screamford Academy, you're in good hands. Our expert instructors and
        comprehensive study materials will guide you every step of the way.
      </p>
      <p>
        We offer specialized courses tailored to help you succeed in various
        civil service examinations. Our curriculum is designed to cover all
        essential topics comprehensively, ensuring that you are well-prepared
        for the exam day.
      </p>
      <p>
        Join us at Screamford Academy and take the first step towards a
        successful career in civil service!
      </p>
